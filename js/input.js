...
export class Input {
  constructor(canvas) {
    ...
    if (js) {
      js.addEventListener('pointerdown', (e) => this.onJoyStart(e));
      js.addEventListener('pointermove', (e) => this.onJoyMove(e));
      js.addEventListener('pointerup', () => this.onJoyEnd());
      js.addEventListener('pointercancel', () => this.onJoyEnd());
    }
